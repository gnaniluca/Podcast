var arrayColori = [
  ...
  document.getElementById('slot1').innerHTML = arrayColori[0];
document.getElementById('slot2').innerHTML = arrayColori[2];
...
function gioca(){
 document.getElementById("button-slot").disabled = true;
  ...
  slot1 = setInterval(function(){
    numeroRandom = generaRandom(arrayColori.length);
    document.getElementById("slot1").innerHTML = arrayColori[numeroRandom];
    console.log(arrayColori[numeroRandom]);
    t1++;
    if (t1 == tentativi) {
      clearInterval(slot1);
      return null;
  ...
  slot2 = setInterval(function(){
    ...
    numeroRandom = generaRandom(arrayColori.length);
    document.getElementById("slot2").innerHTML = arrayColori[numeroRandom];
    console.log(arrayColori[numeroRandom]);
  }, 100);
